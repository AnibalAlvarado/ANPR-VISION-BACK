...
namespace Entity.Migrations.pgAdmin
{
    ...
    [Migration("20251001203631_notificationaddedmigration")]
    partial class notificationaddedmigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.Models.PasswordReset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Entity.Models.PersonParking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Entity.Models.Client", b =>
                {
                    b.HasOne("Entity.Models.Person", "Person")
                        .WithOne("Client")
                        .HasForeignKey("Entity.Models.Client", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
